...
function ENT:CustomOnInitialize()
    ...
    self:SetColor(Color(50, 200, 50, 150))
    self:AddRelationship("npc_headcrab_poison D_LI 99")
	self:AddRelationship("npc_headcrab_fast D_LI 99")
end

function ENT:GoInvis()
    self:SetColor(Color(50, 200, 50, 50))
    self.Horde_Gamma_Invis = true
end

function ENT:UnInvis()
    self:SetColor(Color(50, 200, 50, 255))
...
VJ.AddNPC("Xeno Gamma Gonome","npc_vj_horde_xeno_gamma_gonome", "Zombies")