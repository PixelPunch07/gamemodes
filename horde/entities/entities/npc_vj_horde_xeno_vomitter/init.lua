...
function ENT:ExecuteRangeAttack()
	if self.EnemyData.Distance <= self.RangeDistance and self.EnemyData.Distance >= self.RangeToMeleeDistance then
...
VJ.AddNPC("Xeno Vomitter","npc_vj_horde_xeno_vomitter", "Zombies")