...
AddCSLuaFile("gui/cl_waveset.lua")
AddCSLuaFile("gui/cl_startup_vote.lua")
...
AddCSLuaFile("gui/cl_arccwcustomize.lua")
...
include("status/debuff/sv_nervous_impairment.lua")
include("sv_tip.lua")
...
--AddCSLuaFile("arccw/attachments/horde_go_perk_burst_fire.lua")
--AddCSLuaFile("arccw/attachments/horde_go_perk_agile_maneuver.lua")
--AddCSLuaFile("arccw/attachments/horde_go_perk_auto_reload.lua")
...
AddCSLuaFile("arccw/attachments/horde_go_ammo_sg_triple.lua")
AddCSLuaFile("arccw/attachments/horde_go_ammo_sg_sabot.lua")
AddCSLuaFile("arccw/attachments/horde_go_ammo_sg_slug.lua")
AddCSLuaFile("arccw/attachments/horde_go_ammo_sg_scatter.lua")
AddCSLuaFile("arccw/attachments/horde_go_ammo_sg_magnum.lua")
...
AddCSLuaFile("arccw/attachments/horde_go_nova_mag_8.lua")
AddCSLuaFile("arccw/attachments/horde_go_mag7_mag_3.lua")
AddCSLuaFile("arccw/attachments/horde_go_mag7_mag_7.lua")
AddCSLuaFile("arccw/attachments/horde_go_870_mag_4.lua")
AddCSLuaFile("arccw/attachments/horde_go_870_mag_8.lua")
AddCSLuaFile("arccw/attachments/horde_go_m1014_mag_4.lua")
AddCSLuaFile("arccw/attachments/horde_go_m1014_mag_8.lua")
