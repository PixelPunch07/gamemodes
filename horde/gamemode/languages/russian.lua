...
LANGUAGE["Game_Next_Wave_Number"] = "Волна "
LANGUAGE["Game_Next_Wave_Starts_In"] = "начнется через %d секунд"
...
LANGUAGE["Game_Difficulty_MALICE"] = "ЗЛОБА"
...
LANGUAGE["Game_F4_CannotSkip"] = "Вы не можете пропустить прямо сейчас!"
LANGUAGE["Game_F4_Starting"] = "Начинается следующая волна!"
LANGUAGE["Game_F4_Readied"] = "Вы уже прожали готовность!"
...
LANGUAGE["Infusion_Ruination"] = "Губительная"
...
Преобразует 75% урона от оружия в электрический урон.
...
Урон от выстрела не в голову уменьшен на 25%.
]]

LANGUAGE["Infusion_Description_Rejuvenating"] = [[
Усиливает исцеление от оружия/высасывание здоровья на 25%.

На 20% меньше урона от оружия.
]]

LANGUAGE["Infusion_Description_Quicksilver"] = [[
Увеличивает/уменьшает урон от оружия в зависимости от свободного веса игрока.

<= 15% веса -> увеличение урона на 30%
<= 30% веса -> увеличение урона на 25% 
<= 40% веса -> увеличение урона на 15% 
>40% веса -> уменьшение урона на 25%
]]
...
+1 ед. здоровья, когда вы убиваете врага.

На 20% меньше урона от оружия.
]]

LANGUAGE["Infusion_Description_Chrono"] = [[
Чем дольше оружие находится в руках пользователя, тем больше урона от оружия.

На 6% увеличивается урон за каждую волну, где продерживается пользователь.
Увеличение ограничено 50%.

На 20% уменьшен урон от оружия.
]]
...
LANGUAGE["Rank_Elite"] = "Элита"
LANGUAGE["Rank_Veteran"] = "Ветеран"
LANGUAGE["Rank_Legend"] = "Легенда"
...
Имеет полный доступ к штурмовым винтовкам.]]

LANGUAGE["Class_Description_Heavy"] = [[
Имеет полный доступ к пулемётам и тяжеловесному вооружению.]]

LANGUAGE["Class_Description_Medic"] = [[
Имеет доступ к большинству лёгкому вооружению и медицинскими инструментами.]]

LANGUAGE["Class_Description_Demolition"] = [[
Имеет полный доступ к взрывному вооружению.]]

LANGUAGE["Class_Description_Ghost"] = [[
Имеет доступ к снайперским винтовкам и определенному лёгкому вооружению.
...
Имеет доступ к оружию ближнего боя и к некоторому снаряжению дальнего боя.]]
...
На {1} увеличена скорость передвижения. ({2} за каждый уровень, вплоть до {3}).
На {5} увеличен Баллистический урон. ({6} за каждый уровень, вплоть до {7}).
...
На {6} увеличено количество максимальной брони. ({7} за каждый уровень, вплоть до {8}).


Регенерирует {1} единицу брони в секунду.
Регенерирует до {2} брони. ({3} + {4} за каждый уровень, вплоть до {5})]]
...
Усиливает исцеление на {1}. ({2} за каждый уровень, вплоть до {3}).
...
На {7} увеличен урон от взрыва. ({8} за каждый уровень, вплоть до {9}).
На {1} повышена устойчивость ко взрыву. ({2} + {3} за каждый уровень, вплоть до {4}).

Производит {5} осколочную гранату каждые {6} секунд, если у вас её нету.]]

LANGUAGE["Perk_ghost_base"] = [[
Класс "Призрак" сосредоточен на уничтожение боссов, используя Камуфляж.
Cложность: ВЫСОКАЯ

Урон в голову увеличен на {1}. ({2} за каждый уровень, вплоть до {3}).
...
На {1} увеличен урон от миньонов. ({2} за каждый уровень, вплоть до {3}).

У турелей имеется {4} базового здоровья и наносят {5} базового урона.]]

LANGUAGE["Perk_berserker_base"] = [[
Класс "Берсеркер" - это класс, сосредоточенный на ближний бой, за которого можно играть в нападении, так и в защите.
Cложность: ВЫСОКАЯ

На {1} увеличен урон в ближнем бою. ({2} за каждый уровень, вплоть до {3}).
На {4} увеличена устойчивость к любому урону. ({5} за каждый уровень, вплоть до {6}).

Находясь на земле, прыгните чтобы активировать воздушное парирование.
Во время воздушного или активного парирования получаемый физический урон уменьшен на {7}.
Воздушное парирование пропадает, когда вы приземляетесь на землю.

Нажмите Shift + E для активного парирования в воздухе или на земле.
Активное парирование длится {8} секунды.
При успешном активном парировании длительность обновляется.
Активное парирование изначально не имеет времени восстановления.
Время восстановления повышается на {9} секунду после каждого неудачного активного парирования после первой попытки.
Время восстановления сбрасывается после успешного активного парирования.
Время восстановления сбрасывается, если вы не использовали активное парирование в течение {10} секунд.

(Рекомендуется забиндить "horde_use_perk_skill" на клавишу или кнопку мыши)
]]
...
На {1} увеличен радиус Ауры Надзирателя. ({2} за каждый уровень, вплоть до {3}).
...
На {1} увеличена устойчивость к огненному урону. ({2} + {3} за каждый уровень, вплоть до {4}).
...
Наносит нарастающее кровотечение на {1} от базового урона в ближнем бою. ({2} + {3} за каждый уровень, вплоть до {4}).
На {5} увеличена устойчивость к любому урону. ({6} за каждый уровень, вплоть до {7}).
...
На {1} увеличена скорость передвижения в тактическом режиме. ({2} за каждый уровень, вплоть до {3})
На {1} увеличен урон при подании в голову в тактическом режиме. ({2} за каждый уровень, вплоть до {3})]]

LANGUAGE["Perk_gunslinger_base"] = [[
На {1} увеличен урон от пистолета. ({2} за каждый уровень, вплоть до {3}).
...
Наносит нарастающий шок на {1} от базового урона от электричества. ({2} + {3} за каждый уровень, вплоть до {4}).
На {5} увеличен урон от огня и электричества. ({6} за каждый уровень, вплоть до {7}).
...
Наносит нарастающее обморожение на {1} от базового урона от холода. ({2} + {3} за каждый уровень, вплоть до {4}).
На {5} увеличена устойчивость к урону от холода. ({6} за каждый уровень, вплоть до {7}).
...
Класс "Псих" сфокусирован на нанесении критического урона оружиями ближнего и дальнего боя.

Добавляет {1} шанс нанести критическое попадание. ({2} + {3} за каждый уровень, вплоть до {4}).
Вы наносите на {5} больше урона при критическом попадании.

Атакуя врагов атаками ближнего боя, вы получаете Брутальность, вплоть до {6} стаков.
Каждый стак Брутальности добавляет {7} к базовому шансу критического попадания.


Нажмите Shift + E, чтобы войти в режим Безумия.
Вы теряете {8} здоровье каждые {9} секунды, вплоть до {10} здоровья.
На {11} увеличен шанс критического удара в режиме Безумия.
На {12} увеличено восстановление здоровья в режиме Безумия.
...
На {1} увеличена максимальная мана. ({2} за каждый уровень, вплоть до {3}).
...
На {1} увеличено максимальное здоровье. ({2} за каждый уровень, вплоть до {3}).
...
На {1} увеличена скорость эволюции муравьиных львов. ({2} за каждый уровень, вплоть до {3}).
На {1} увеличен урон от яда. ({2} за каждый уровень, вплоть до {3}).
...
Класс "Повелитель" сфокусирован на ослаблении врагов своим устрашающим присутствием,
заставляя их получать больше урона и наносить меньше урона.

Урон от дробовиков возрастает на {1} ({2} за каждый уровень, вплоть до {3}).
Радиус присутствия увеличен на {4} ({5} за каждый уровень, вплоть до {6}).

Ваш активный навык-перк также связан с вашим присутствием.

Враги в вашем присутствии одержимы Страхом.
Враги, одержимые Страхом, также одержимы Агонией и Страданием.

Враги, одержимые Агонией, получают на {7} больше урона.
Враги, одержимые Страданием, наносят на {8} меньше урона.

Максимальное количество стаков Страха - {9}.
Страх длится {10} и спадывает одним за другим.
Максимальное количество стаков Страха увеличивается на {11} с каждым открытым тиром перков.

Имеет доступ к дробовикам и модулям сторожевых башен, которые расширяют ваше присутствие.

Нажмите Shift + E, чтобы использовать Взрыв Тёмной Энергии, который стреляет в ваших врагов энергетическим шаром Комбайнов,
наносящий урон по площади в зависимости от количества стаков Страха.

Взрыв Тёмной Энергии -
Не может быть выстрелом в голову.
Наносит {12} физического урона за каждый стак Страха.
Радиус взрыва равен радиусу вашего присутствия.
Присутствие сохраняется в течение {13} секунд.
Имеет перезарядку в {14} секунд.
...
Игроки поблизости так же получают {1} адреналин, вплоть до {2}.
...
Ослабленные враги получают на {1} больше физ. урона.]]
...
Пока у вас есть хотя-бы {1} брони:
  Вы получаете на {2} меньше физического урона.]]
...
Ваш баллистический урон увеличен на {1}.
Эффект дебаффов, которыми вы накладываете, увеличен на {2}.]]
...
Пока на вас наложен Берсерк, урон увеличен на {2}.]]
...
Ваше исцеление сокращает накопление кровотечения, разрыва и некроза.]]

LANGUAGE["Perk_Title_medic_haste"] = [[Спешка]]
LANGUAGE["Perk_medic_haste"] = [[
Игроки, которых вы исцелили, получают спешку на {1} секунд.
Пока на вас наложена Спешка, скорость передвижения увеличена на {2}.]]
...
Взрыв гранат и ВЛУБов увеличивают накопление оглушения.]]
...
Отсроченный взрыв наносит {1} урона от взрыва в виде Физического урона.
Активируется только тогда, когда урона больше {2}.]]
...
На {2} больше дробящего урона и урона от взрыва при попадании в голову.]]
...
Увеличение урона ограничено до {2}.]]
...
Урон от выстрела в голову добавляет стак вплоть до {1} раз.
...
Урон увеличен на {1} за каждые {2} единиц.
Увеличение ограничено {3}.]]

LANGUAGE["Perk_Title_Ghost_Tier_4"] = [[Удаление]]
LANGUAGE["Perk_Title_ghost_coup"] = [[Смертельный удар]]
LANGUAGE["Perk_ghost_coup"] = [[
Вы мгновенно убиваете врагов с запасом здоровья менее 20%.]]

LANGUAGE["Perk_Title_ghost_decapitate"] = [[Обезглавить]]
LANGUAGE["Perk_ghost_decapitate"] = [[
Пока у вас имеется камуфляж:
  Баллистический урон увеличен на {1}.
  Урон в голову против элитных врагов увеличен на {2}.]]
...
Миньоны высасывают {1} от нанесенного урона вплоть до {2} ед. здоровья за удар.
...
Щит поглощает урон вплоть до {1} от здоровья миньона.
...
Вы регенерируетесь {1} от максимального здоровья за секунду.
Иммунитет к урону от яда и к накоплению разрыва.]]

LANGUAGE["Perk_Title_berserker_bloodlust"] = [[Жажда крови]]
LANGUAGE["Perk_berserker_bloodlust"] = [[
Вы высасываете {1} от урона ближнего боя, вплоть до {2} ед. здоровья за удар.
Иммунитет к накоплению кровотечения.]]
...
На {2} увеличен урон оружия ближнего боя.]]
...
При успешном воздушном парировании снимаются все дебаффы и накопления дебаффов.
При успешном воздушном парировании восстанавливается {1} здоровья и 
вы регенерируетесь по {2} от максимального здоровья в секунду на {3} секунд.]]

LANGUAGE["Perk_Title_berserker_unwavering_guard"] = [[Непоколебимый страж]]
LANGUAGE["Perk_berserker_unwavering_guard"] = [[
Ваше воздушное парирование работает против всех типов урона.
При успешном воздушном парировании урон ближнего боя увеличен на {1} на {2} секунд.
При успешном воздушном парировании получаемый урон уменьшен на {3} на {4} секунд.]]
...
Вы получаете {1} стак Фаланги за удар по врагу, вплоть до {2} стаков.
Каждый стак на {2} увеличивает устойчивость от физического урона.
Каждый стак длится {4} секунд и пропадает один за другим.]]
...
Не разрезающее оружие ближнего боя наносит {2} урона окружающим целям.]]
...
Ваш максимальный вес уменьшается вплоть до 7.
На {1} больше урона в ближнем бою.
+3 блок урона.]]
...
На {1} увеличен баллистический урон в секунду вплоть до {2}.
+{3} блок урона за секунду вплоть до {4}]]
...
урон заклинания увеличивается на {1} вплоть до {2}.
...
Выстрел в голову добавляет стак вплоть до {1} раз.
...
LANGUAGE["Perk_Title_Psycho_Tier_1"] = [[Садизм]]
LANGUAGE["Perk_Title_psycho_bloodbath"] = [[Кровавая баня]]
LANGUAGE["Perk_psycho_bloodbath"] = [[
Добавляет {1} к базовому шансу критического попадания.
...
Высасывает {2} здоровья от нанесенного урона оружием ближнего боя.
Высасывание ограничивается до {3} здоровья за удар или до {4} за крит. попадание.]]

LANGUAGE["Perk_Title_Psycho_Tier_2"] = [[Насилие]]
LANGUAGE["Perk_Title_psycho_ferocity"] = [[Свирепость]]
LANGUAGE["Perk_psycho_ferocity"] = [[
Добавляет {1} к шансу критического попадания.
Добавляет {2} к шансу критического попадания за каждую {3} потерянного здоровья.]]

LANGUAGE["Perk_Title_psycho_disembowel"] = [[Потрошить]]
LANGUAGE["Perk_psycho_disembowel"] = [[
На {1} увеличен урон при критическом попадании.
Атаки ближнего боя снимают мутацию немезиса у врагов.]]
...
Игроки имеют +{1} к базовому шансу критического попадания,
когда они бьют пронзенных врагов.]]

LANGUAGE["Perk_Title_psycho_brutality"] = [[Брутальность]]
LANGUAGE["Perk_psycho_brutality"] = [[
Брутальность добавляет дополнительные {1} к базовому шансу крит. попадания.
Брутальность также увеличивает урон критического попадания на {2}.
Стаки Брутальности пропадают на {3} медленнее.]]

LANGUAGE["Perk_Title_Psycho_Tier_4"] = [[Психоз]]
LANGUAGE["Perk_Title_psycho_grudge"] = [[Обида]]
LANGUAGE["Perk_psycho_grudge"] = [[
На {1} повышена скорость передвижения за каждую потерянную {2} ОЗ, до {3}.
На {4} повышен урон крит. попадания за каждую потерянную {5} ОЗ. 
Утроен урон критами ближ. боя. Считается, что у вас {6} ОЗ, если ОЗ выше {7}.]]

LANGUAGE["Perk_Title_psycho_bestial_wrath"] = [[Звериный гнев]]
LANGUAGE["Perk_psycho_bestial_wrath"] = [[
На {1} увеличен урон при критическом попадании.
Не разрезающее оружие ближнего боя наносит {2} урона по окружающим целям.
В режиме Безумия здоровье падает на {3} медленнее.]]
...
Прибавляет +{1} к максимальному количеству Гипертрофических стаков.
Добавляет {2} шанс получить Гипертрофию, когда вы ударили врага.]]
...
Вы восстанавливаете {2} здоровья, когда получаете любое накопление дебаффа.]]

LANGUAGE["Perk_Title_overlord_dispersion"] = [[Дисперсия]]
LANGUAGE["Perk_overlord_dispersion"] = [[
Накладывание Страха уменьшает накопление дебаффов на {1}.]]
...
Взрыв Тёмной Энергии наносит на {1} больше урона.
Перезарядка Взрыва Тёмной Энергии снижена на {2}.]]

LANGUAGE["Perk_Title_overlord_juxtapose"] = [[Сопоставление]]
LANGUAGE["Perk_overlord_juxtapose"] = [[
Перк с навыком Взрыв Тёмной Энергии заменен Призывом Проекционного Клона.
Проекционный Клон имеет {1} здоровья и использует помповый дробовик.
Проекционный Клон длится {2} секунд и имеет перезарядку в {3} секунд.]]
...
Длительность Страха бесконечно.
Враги, которых вы бьете, получают {1} стак Страха.]]
...
Наносит дополнительный урон от электричества.
80% дополнительного урона от электричества способствует накоплению шока.
...
Скорость передвижения при взятии этого оружия увеличивается на 25%.
...
Тяжелая атака имеет более широкую площадь разреза.
...
Меч ниндзя. Большая дальность атаки и высокая скорость атаки.
...
Прочная бейсбольная бита. Бьёт, как грузовик.
...
Пожарный топор. Тяжелый, но может разрубать многих врагов пополам.

Удар в голову тяжелой атакой всегда оглушает врага в первый раз,
когда получает оглушение от пожарного топора.
...
Когда включен:
Вы получаете 1 урон от огня в секунду.
Оружие наносит дополнительный урон от огня
Удар оружия выпускает огненный взрыв, поражающий ближайших врагов.

ЛКМ - Лёгкая атака
Разрез - 3

ПКМ - Эффект переключения заряда
Урон от огня - 50
]]
...
Наносит больше урона при использовании топлива.
Тяжелые атаки требуют топливо.
...
Пока заряжен:
Оружие наносит дополнительный урон от электричества.
Удар оружия выпускает электрический шторм, поражающий ближших врагов.

ЛКМ - Лёгкая атака
Разрез - 3

ПКМ - Эффект активации заряда
Урон от электричества - 150
]]
...
Оружие наносит дополнительный урон от холода.
Тяжелые атаки выпускают ледяной взрыв, поражающий ближайших врагов.
15% дополнительного урона от холода тяжелыми атаками способствует накоплению обморожения.
Вы получаете 15 единиц накопления обморожения при каждом выпуске ледяного взрыва.
...
Тяжелый, огромный двуручный длинный меч. Может запросто обезглавить врагов при полном размахе.
...
LANGUAGE["Item_Medic Grenade"] = [[Медицинская Граната]]
...
LANGUAGE["Item_Throwing_Knives"] = [[Метательные ножи]] 
LANGUAGE["Item_Desc_Throwing_Knives"] = [[
Метательные ножи, которые наносят режущий урон и считаются оружием ближнего боя.
Могут быть подняты после соприкосновения с поверхностями и не зацепляются в стенах и потолках.
С побеждённых врагов сбрасываются все пронзенные метательные ножи.
]]
...
Совершает рывок вперед, нанося режущий урон всем врагам на пути.

Активный Гаджет:
Наносит {1} режущего урона.
Неуязвим ко всем видам урона в течение {2} секунд во время рывка.
У вас есть Фазирование на {3} секунд во время рывка.
На {4} снижен получаемый урон от падения до тех пор, пока вы не приземлитесь.
{5} шанс того, что вы и ваши союзники отправитесь прямиком в теневой мир.
]]
...
Перезаряжается за 5 секунд.
]]

LANGUAGE["Gadget_gadget_omnislash"] = [[Всенаправленный разрез]]
LANGUAGE["Gadget_Desc_gadget_omnislash"] = [[
Поэтапно отказывается от реальности и раз за разом наносит удары по целевому врагу.
Каждый разрез наносит 50 урона.
Отпрыгивает к ближайшей цели, если главная цель мертва.
...
Истерия длится 5 секунд и спадывает одним за другим.
]]

-- Overlord Gadgets
LANGUAGE["Gadget_gadget_shotgun_surgeon"] = [[Хирург с дробовиком]]
LANGUAGE["Gadget_Desc_gadget_shotgun_surgeon"] = [[
Активный Гаджет:
Бросает исцеляющий флакон перед вами.
Исцеляющий флакон восстанавливает {1} очков здоровья.
...
Активный Гаджет:
Запускает перед вами энергетический шар Комбайнов меньшего размера.

Наследует свойства от навык-перка "Взрыв Тёмной Энергии".
Наносит на {1} меньше урона, если у вас есть навык-перк "Взрыв Тёмной Энергии".
Время перезарядки исправлено.
]]

LANGUAGE["Gadget_gadget_reinforcements"] = [[Подмога]]
LANGUAGE["Gadget_Desc_gadget_reinforcements"] = [[
Активный Гаджет:
Призывает меньшую версию Проекционного Клона с помповым дробовиком.

Наследует свойства навык-перка "Сопоставление".
Меньшая версия Проекционного Клона имеет на {1} меньше здоровья.
]]

LANGUAGE["Gadget_gadget_emergency_reload"] = [[Экстренная перезарядка]]
...
-- Dank Patch notes
-- LANGUAGE["Game_Dank_Patch_Notes"] = [[Сырое Обновление 2.1.0]]
-- LANGUAGE["Game_Dank_Patch_Notes_Info"] = [[Coming later]]
